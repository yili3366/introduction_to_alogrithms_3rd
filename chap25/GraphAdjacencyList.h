...
#ifndef CHAP24_GRAPHADJACENCYLIST_H
#define CHAP24_GRAPHADJACENCYLIST_H
...
//            for (std::list<Edge>::iterator edgeIter = nodeIter->mHead->begin(); edgeIter != nodeIter->mHead->end();
//                 edgeIter++) {
//                std::cout << " key " << nodeIter->mKey << " distance " << nodeIter->mDistance << std::endl;
//                D.at(edgeIter->mEdge.first).at(edgeIter->mEdge.second) = nodeIter->mDistance
//                    + h.at(edgeIter->mEdge.second) - h.at(edgeIter->mEdge.first);
//            }
...
//                std::cout << " u key " << outerNodeIter->mKey <<  " v key " << innerNodeIter->mKey
//                          << " distance " << innerNodeIter->mDistance << " u " << h.at(outerNodeIter->mKey) << " v "
//                          << h.at(innerNodeIter->mKey) << std::endl;
